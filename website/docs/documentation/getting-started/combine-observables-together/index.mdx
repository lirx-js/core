...
The simplest combinator of Observable is **[merge](../../../reference/merge)**.
...
This may be done with the function **[combineLatest](../../../reference/combine-latest)**.
...
This function is called **[reactiveFunction](../../../reference/reactive-function)**.
