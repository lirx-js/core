...
So, the first thing to do, is to define **what** is an [Observer](../../../reference/observer):
...
Let's define the [Observable](../../../reference/observable):
...
But don't stop here, the **strength** of Reactive Programing is due to its **[piping possibilities](../what-is-an-observable-pipe)**.
