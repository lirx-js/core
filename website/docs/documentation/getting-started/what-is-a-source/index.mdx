...
We can create a one using the function [createReplaySource](/docs/reference/create-replay-source/),
...
We can create a one using the function [createReplayLastSource](/docs/reference/create-replay-last-source/), but like the previous one,
...
In 99% we'll use the shortcut **[let$$](/docs/reference/create-multicast-replay-last-source/)** to create a MulticastReplayLastSource.
