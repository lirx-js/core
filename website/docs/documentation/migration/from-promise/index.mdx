...
However, an Observable may emit **any kind of value**. In order to mimic the behaviour of a Promise we will use some **[Notifications](/docs/documentation/observables/what-is-a-notification/)**:
