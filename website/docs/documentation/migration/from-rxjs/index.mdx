...
This is somehow, like if they were only sending `next`. To send a state, we have to use some [Notifications](/docs/documentation/observables/what-is-a-notification/).

## Subject, BehaviorSubject and ReplaySubject

They are replaced by [Sources](/docs/documentation/observables/what-is-a-source/):
