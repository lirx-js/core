...
> **Reactive Programming** is a different way to develop, work with evolving values and manage asynchronous data streams.
...
Reactive Programming uses a different approach: **you'll build many streams of values called `Observables`.**
