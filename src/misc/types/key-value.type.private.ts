...
export type IInferKeyValueTupleGKey<GKeyValueTuple extends IGenericKeyValueTuple> =
  GKeyValueTuple extends IKeyValueTuple<infer GKey, any> ? GKey : never;

export type ITInferKeyValueTupleGValue<GKeyValueTuple extends IGenericKeyValueTuple> =
  GKeyValueTuple extends IKeyValueTuple<any, infer GValue> ? GValue : never;
...
export type IInferKeyValueTupleUnionGValueFromKey<
  GKeyValueTupleUnion extends IGenericKeyValueTuple,
  GKey extends IInferKeyValueTupleUnionGKey<GKeyValueTupleUnion>,
...
export type IKeyValueTupleUnionToKeyValueMap<GKeyValueTupleUnion extends IGenericKeyValueTuple> = {
  [GKey in IInferKeyValueTupleUnionGKey<GKeyValueTupleUnion>]: GKeyValueTupleUnion extends IKeyValueTuple<
    GKey,
    infer GValue
  >
    ? GValue
