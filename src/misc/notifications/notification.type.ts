...
export type TInferNotificationGName<GNotification extends IGenericNotification> =
  GNotification extends INotification<infer GName, any> ? GName : never;

export type TInferNotificationGValue<GNotification extends IGenericNotification> =
  GNotification extends INotification<string, infer GValue> ? GValue : never;

export type TInferGValueFromNotificationsUnionAndName<
  GNotificationsUnion extends IGenericNotification,
  GName extends TInferNotificationGName<GNotificationsUnion>,
